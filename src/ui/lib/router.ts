...
/**
 * Seven static screens, no deep links, no data loading per route: `hashchange` is the whole
 ...
 */
export const ROUTES = ['/', '/dashboard', '/gate', '/insurance', '/market', '/explorer', '/findings'] as const
